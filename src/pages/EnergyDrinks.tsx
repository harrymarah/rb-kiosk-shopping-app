  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative bg-gradient-to-br from-purple-900 via-blue-900 to-purple-800 text-white overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 py-12 flex items-center justify-center min-h-[140px] cursor-pointer" onClick={() => setSelectedCategory("all")}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
            <div className="relative mb-3 bg-white rounded-lg p-3 shadow-sm">
              <img 
                src="https://ytmpkdrfujdbfkfhnimq.supabase.co/storage/v1/object/public/Food%20Delivery%20Assets/qcom/products/Red%20Bull/12.%20Red%20Bull%20Sugar%20Free%20Energy%20Drink%2012%20X%20250ml.jpeg"
